...
(define (printIdentifier string out)
        (display "<span class='identificador'>\n" out) 
            (display string out)
          (display "</span>\n" out)  
)
...
(define (iterate lst out)
  (unless (empty? lst) ;verifica que no este vacia
    (cond ;aplica funcionaes condicionales para evaluar los strings
      ...
      [(isElse(first lst)) 
              (display "<span class='else'>\n" out) 
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isBoolean(first lst)) 
              (display "<span class='boolean'>\n" out) 
                (display (first lst) out)
              (display "</span>\n" out)
        ]
      [(isImport(first lst)) 
      ...
      [(isEnd(first lst)) 
              (display "<span class='end'>\n" out) 
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isFor(first lst)) 
              (display "<br><span class='for'>\n" out) 
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isReal (first lst)) 
              (display "<span class='real'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isMinorEqual(first lst)) 
              (display "<span class='minorEqual'>\n" out) 
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isMajorEqual(first lst)) 
              (display "<span class='majorEqual'>\n" out)
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isEqual(first lst)) 
              (display "<span class='equal'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isDiferente(first lst)) 
              (display "<span class='diferente'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isMasmas(first lst))
              (display "<span class='masMas'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isAsignacion (first lst))
              (display "<span class='asignacion'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isMajor(first lst)) 
              (display "<span class='major'>\n" out) 
                (display (first lst) out)
              (display "</td>\n" out)
      ]
      [(isMinor(first lst))
              (display "<span class='minor'>\n" out) 
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isSuma (first lst))
              (display "<span class='suma'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isResta (first lst))
              (display "<span class='resta'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isMultiplicacion (first lst)) 
              (display "<span class='multiplicacion'>\n" out)   
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isDivision (first lst)) 
              (display "<span class='division'>\n" out)
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isPotencia (first lst)) 
              (display "<span class='potencia'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isModulus (first lst)) 
              (display "<span class='modulo'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isParentesisAbre (first lst)) 
              (display "<span class='parentesis'>\n" out) 
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      ...
      [(isCurlyBracketAbre (first lst)) 
              (display "<span class='llaves'>\n" out)
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isCurlyBracketCierra (first lst))
              (display "<p class='llaves'>\n" out)  
                (display (first lst) out)
              (display "</p>\n" out)
      ]
      [(isEntero (first lst)) 
              (display "<span class='entero'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      ;reservados, hace catch si no encuentra especificamente la necesaria
      [(isReserved (first lst)) 
              (display "<span class='reservada'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isString (first lst))
              (display "<span class='string'>\n" out)
                (display (first lst) out)
                (display  " " out)
      ...
      [(isComma (first lst)) 
              (display "<span class='coma'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      [(isDosPuntos (first lst)) 
              (display "<span class='dosPuntos'>\n" out)  
                (display (first lst) out)
              (display "</span><br>\n" out)
      ]
      [(isPuntoComa (first lst)) 
              (display "<span class='puntoComa'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]
      ;operadores, hace catch si no encuentra especificamente la necesaria
      [(isOperador (first lst)) 
              (display "<span class='operador'>\n" out)  
                (display (first lst) out)
              (display "</span>\n" out)
      ]        
      [else 
              (display "<span class='errorFormato'>\n" out)
                (display (first lst) out)  
              (display "</span>\n" out)  
      ] 
    ) 
